    ...
    <div>
      <Event
        ...
        description={[
          ...
          'To keep things simple, I will be using Strava to time the event, and we will be following the course map from the 2016 CES. Anyone who completes all 6 stages before I calculate the results on the evening of March 15th will be counted in the final results.',
          'For those that want to roll out as a group, the main “event” will start at the softball fields on Saturday, May 14th at 9:30am. ',
